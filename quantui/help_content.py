...
HELP_TOPICS: Dict[str, Dict[str, str]] = {
    "getting_started": {
        ...
        "body": (
            ...
            "macOS, or WSL. Native Windows can use the optional PyFock subset "
            "for neutral closed-shell PBE single points and geometry optimization.</p>"
    ...
    "quantum_engine": {
        ...
        "body": (
            ...
            "<p><b>PyFock</b> is deliberately narrower: neutral, closed-shell "
            "PBE single points and geometry optimizations with def2-SVP or "
            "def2-TZVP. Density fitting is always on, analytical gradients drive "
            "geometry optimization, and orbital/population analysis is retained. "
            "Unsupported methods and controls disappear "
