...
HELP_TOPICS: Dict[str, Dict[str, str]] = {
    ...
    "resuming_calculations": {
        ...
        "body": (
            ...
            "<p><b>How to resume.</b> Leave every setting exactly as it was and "
            "return to the <i>Calculate</i> tab. If the interrupted work can be "
            "continued, a line appears just above the <b>Run</b> button:</p>"
